...
@section('content')
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="{{$info['username']?? ''}}" name="user_name" required lay-verify="user_name" placeholder="用户名必须2到12位字母" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">邮箱：</label>
        <div class="layui-input-block">
            <input type="text" value="{{$info['email'] ?? ''}}" name="email" required lay-verify="required|email" placeholder="请输入正确格式邮箱" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" value="{{$info['mobile'] ?? ''}}" name="tel" required lay-verify="required|phone" placeholder="请输入手机号码" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
