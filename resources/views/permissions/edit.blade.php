...
@section('content')
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="{{$info['name'] ?? ''}}" name="permission_remark" required lay-verify="permission_remark" placeholder="请输入2-12位字母" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="{{$info['display_name'] ?? ''}}" name="permission_name" required lay-verify="permission_name" placeholder="请输入2-12位汉字" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="permission_desc" placeholder="请输入2-30位汉字" class="layui-textarea" required lay-verify="permission_desc">{{$info['description'] ?? ''}}</textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="permission_control" placeholder="请输入权限控制" class="layui-textarea" required lay-verify="permission_control">{{$info['controllers'] ?? ''}}</textarea>
